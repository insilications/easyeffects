...
Version  : 6.2.3
Release  : 260
URL      : file:///aot/build/clearlinux/packages/easyeffects/easyeffects-v6.2.3.tar.gz
Source0  : file:///aot/build/clearlinux/packages/easyeffects/easyeffects-v6.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645019304
...
echo PGO Phase 1
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" LIBS="$LIBS" meson --libdir=lib64 --sysconfdir=/usr/share --prefix=/usr --buildtype=plain -Ddefault_library=both  -Ddefault_library=both builddir
